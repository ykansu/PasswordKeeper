...
public class LoginScreen extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogIn.setOnClickListener(new OnClickListener() {
            ...
            private void showPasswordIncorrectMessage(View view) {
                Snackbar.make(view, "Hatalı Şifre Girdiniz !", Snackbar.LENGTH_LONG)
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        emailAddressCollection.add(0,"yasinkansu3@gmail.c");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            Intent ıntent = new Intent(LoginScreen.this,HomeScreen.class);
